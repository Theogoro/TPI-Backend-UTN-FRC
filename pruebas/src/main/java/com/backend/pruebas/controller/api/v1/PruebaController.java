...
public class PruebaController {
    ...
    public ResponseEntity<List<PruebaDTO>> getPruebas(
        ...
        System.out.println("Authorization Header: " + authorizationHeader); // Imprime el token JWT.
    ...
    public ResponseEntity<List<PruebaDTO>> getPruebasInformePorEmpleado(@PathVariable(name = "id") long id){
        return ResponseEntity.ok(pruebaService.getPruebasConIncidentesPorEmpleado(id));
    }
    @GetMapping("/informe/incidentesPorVehiculo/{id}")
    public ResponseEntity<List<PruebaDTO>> getPruebasInformePorVehiculo(@PathVariable(name = "id") long id){
